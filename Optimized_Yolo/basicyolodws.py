...
# Layer 3
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_3', use_bias=False)(x)
...
# Layer 5
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_5', use_bias=False)(x)
...
# Layer 6
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_6', use_bias=False)(x)
...
# Layer 8
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_8', use_bias=False)(x)
...
# Layer 9
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_9', use_bias=False)(x)
...
# Layer 11
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_11', use_bias=False)(x)
...
# Layer 13
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_13', use_bias=False)(x)
...
# Layer 14
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_14', use_bias=False)(x)
...
# Layer 16
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_16', use_bias=False)(x)
...
# Layer 18
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_18', use_bias=False)(x)
...
# Layer 19
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_19', use_bias=False)(x)
...
# Layer 20
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_20', use_bias=False)(x)
...
# Layer 22
x = Conv2D(1, (3,3), strides=(1,1), padding='same', name='conv_22', use_bias=False)(x)
