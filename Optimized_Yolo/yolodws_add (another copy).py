...
# Layer 8
x = SeparableConv2D(128, (3,3), strides=(2,2), padding='same', name='conv_8', use_bias=False)(x)
...
# Layer 11
x = SeparableConv2D(256, (3,3), strides=(1,1), padding='same', name='conv_11', use_bias=False)(x)
...
# Layer 14
x = SeparableConv2D(512, (3,3), strides=(2,2), padding='same', name='conv_14', use_bias=False)(x)
...
# Layer 20
x = SeparableConv2D(1024, (3,3), strides=(1,1), padding='same', name='conv_20', use_bias=False)(x)
